...
public class TestAndRun implements GLEventListener {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        //6
        MidpointLine(gl, 0, 31, 30, 31);   //-
        MidpointLine(gl, 0, -30, 0, 30);   //|
        MidpointLine(gl, 0, -29, 29, -29); //-
        MidpointLine(gl, 31, -30, 31, -1); //-
        MidpointLine(gl, 0, 0, 29, 0);     //|
        //8
        MidpointLine(gl, 45, 31, 75, 31);  //-
        MidpointLine(gl, 46, -30, 46, 30); //|
        MidpointLine(gl, 45, 0, 75, 0);    //-
        MidpointLine(gl, 76, 31, 76, -29); //|
    ...
    public void MidpointLine(GL2 gl, int x1, int y1, int x2, int y2) {
        ...
        while (x <= x2) {
            ...
            int[] OriginalZone = OriginalZone(zone, x, y);
    ...
    private int[] OriginalZone(int zone, int X, int Y) {
        int array[] = new int[2];
